      ...
      <form>
        ...
        <div className='postPage__setTags'>
          ...
          <input
            ...
            onChange={handleOnChange}
            name='tags'
            placeholder='e.g. nature, science'></input>
        </div>
        ...
        <div className='postPage__submit'>
          <a href='/#' className='postPage__submit__cancel'>
            Cancel
          </a>
          <a
            href='/#'
            className='postPage__submit__submit'
